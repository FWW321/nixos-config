...
<!-- Vendored from https://github.com/Jylhis/claude-marketplace/blob/main/plugins/nix-dev/skills/nixpkgs/SKILL.md (2026-08-19)
     本地适配:删 frontmatter user-invocable 字段(OpenCode/codex 均不识别,上游为 Claude Code 专属)
     与 nix skill 分工:本条 = 打包 API 参考,nix = 判断/约束层(工作流与防坑) -->
